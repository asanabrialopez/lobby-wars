...
using LobbyWars.API.Features.User.Application.SetLastLogin;
...
namespace LobbyWars.API.Extensions
{
    public static class ServiceCollectionExtensions
    {
        ...
        {
            services.AddScoped<IEvaluateContractService, EvaluateContractService>();
            services.AddScoped<ILoginService, LoginService>();
            services.AddScoped<ISetLastLoginService, SetLastLoginService>();
